 ...
 * Usage: node scripts/resend-welcome-emails.js <email1> <email2> ...
 */
...
async function resendWelcomeEmails() {
  ...
  try {
    ...
    if (emails.length === 0) {
      console.log('Usage: node scripts/resend-welcome-emails.js <email1> <email2> ...')
      console.log('\nExample:')
      console.log('  node scripts/resend-welcome-emails.js user1@example.com user2@example.com')
